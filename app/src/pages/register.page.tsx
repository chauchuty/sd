                                ...
                                <div className="col-md-12">
                                    <div className="p-5">
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            <div className="mb-3">
                                                <label htmlFor="ra" className="form-label">Nome</label>
                                                <input {...register("nome", { required: true })} type="text" className="form-control" autoComplete="off" />
                                                {
                                                    errors.ra && <span className="form-text text-danger">Nome é obrigatório</span>
                                                }
                                            </div>
                                            <div className="mb-3">
                                                <label htmlFor="ra" className="form-label">RA (Registro Acadêmico)</label>
                                                <input {...register("ra", { required: true })} type="text" className="form-control" autoComplete="off" />
                                                {
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <input {...register("senha", { required: true })} type="password" className="form-control" autoComplete="off" />
                                                {
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <select  defaultValue={-1} className="form-control form-select" {...register("categoria", { required: true })}>
                                                ...
                                                {
                                                    errors.categoria && <span className="form-text text-danger">Categoria é obrigatório</span>
                                                }
                                            </div>
                                            ...
                                            <div className="mb-3">
                                                <label htmlFor="descricao" className="form-label">Descrição da profissão</label>
                                                <textarea {...register("descricao", { required: true })} className="form-control" autoComplete="off" rows={4} style={{ resize: "none"}} />
                                                {
                                                    errors.ra && <span className="form-text text-danger">Descrição é obrigatório</span>
                                                }
                                            </div>
