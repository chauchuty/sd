...
function SideBarComponent(props: any) {
    return (
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <SideBarItemComponent label="Home" />
            <SideBarItemComponent label="Dashboard" 
                isDropDown 
                anchors={[
                { href: "#", label: "Dashboard 1" },
                { href: "#", label: "Dashboard 2" },
                { href: "#", label: "Dashboard 3" },
                { href: "#", label: "Dashboard 4" },
            ]} />
